<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="ECommerce_Web.Admin.Category" %>
                ...
                <h4 class="card-title">Category List</h4>
                  ...
                  <div class="table-responsive">
                      <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rCategory_ItemCommand">
                          <HeaderTemplate>
                              <table class="table data-table-export table-hower nowrap">
                                  <thead>
                                      <tr>
                          ...
                          <ItemTemplate>
                              <tr>
                                  ...
                                  <td>
                                      <img width="40" src ="<%#ECommerce_Web.Utils.getImageUrl(Eval("CategoryImageUrl"))%>" alt ="image" />
                                  </td>
                                  <td>
